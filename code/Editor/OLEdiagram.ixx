    ...
    private Core::IDocumentChange
{
    ...
    d1::Observer::C<App::IDocument::INameChange> documentNameConnector_;
...
public:
    OLEdiagram(App::IDocument&, StorageHolder&, Core::IDiagram&);

    OLEdiagram(const OLEdiagram&) = delete;
    OLEdiagram& operator=(const OLEdiagram&) = delete;
